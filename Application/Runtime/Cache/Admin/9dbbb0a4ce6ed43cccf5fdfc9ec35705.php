    ...
    <div class="admin-content-body">
      ...
      <div class="am-g">
        <div class="am-u-sm-12 am-u-md-8 am-u-md-push-1">
          <form class="am-form am-form-horizontal" action="<?php echo U('edit_add');?>" method="post">
            <input type="hidden" name="id" value="<?php echo ($id); ?>">
            <div class="am-form-group">
              <label for="user-name" class="am-u-sm-3 am-form-label">菜单名称</label>
              <div class="am-u-sm-9">
                <input type="text" id="user-name" placeholder="" required name="name" value="<?php echo ($data["name"]); ?>">
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input type="text" id="user-email" name="url" required placeholder="" value="<?php echo ($data["url"]); ?>">
              </div>
            </div>
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <select data-am-selected="{btnSize: 'sm'}" name="parent_id">
                  <?php if(is_array($parent_menus)): $i = 0; $__LIST__ = $parent_menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($data['parent_id'] == $vo['id']) echo 'selected' ?>><?php echo ($vo['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>              </div>
            </div>
            ...
            <div class="am-form-group">
             ...
             <div class="am-u-sm-9">
               <label class="am-radio-inline">
                 <input type="radio" name="is_show" value="1"  <?php if($data['is_show'] == 1 || !isset($data['is_show'])) echo 'checked' ?> data-am-ucheck> 是
               </label>
               <label class="am-radio-inline">
                 <input type="radio" name="is_show" value="2" <?php if($data['is_show'] == 2) echo 'checked' ?>  data-am-ucheck> 否
               </label>
             </div>
            </div>
