    ...
    <div class="admin-content-body">
      ...
      <div class="am-g">
        <div class="am-u-sm-12 am-u-md-8 am-u-md-push-1">
          <form class="am-form am-form-horizontal" action="<?php echo U('add_edit_goodsclass');?>" method="post">
            <input type="hidden" name="id" value="<?php echo ($data['id']); ?>">
            <div class="am-form-group">
              <label for="user-name" class="am-u-sm-3 am-form-label">分类名称</label>
              <div class="am-u-sm-9">
                <input type="text" id="user-name" required placeholder="" name="name" value="<?php echo ($data["name"]); ?>">
              </div>
            </div>
            <div class="am-form-group">
              <label for="user-email" class="am-u-sm-3 am-form-label">排序</label>
              <div class="am-u-sm-9">
                <input type="text" id="user-email" required name="sort" placeholder="" value="<?php echo ($data["sort"]); ?>">
              </div>
            </div>
