  ...
  <div class="admin-content">
    <div class="admin-content-body">
      ...
      <form class="am-g" action="<?php echo U('userList');?>" method="get">
        ...
        <div class="am-u-sm-12 am-u-md-2">
          <div class="am-form-group">
            <?php $medical = C('USER_MEDICAL'); ?>
            <select data-am-selected="{btnSize: 'sm'}" name="medical">
              <option value="0">会员病史</option>
              <?php if(is_array($medical)): $i = 0; $__LIST__ = $medical;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
          </div>
        </div>
          ...
          <div class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td><?php $role = C('ROLE'); echo $vo['status'] == 2 ? '已开通' : '未开通'; ?></td>
                  <td class="am-hide-sm-only"><?php echo ($role[$vo['role']]); ?></td>
                  <td class="am-hide-sm-only"><?php echo ($vo['higher_id']); ?></td>
                  <td class="am-hide-sm-only"><?php echo ($vo['service_id']); ?></td>
                  <td class="am-hide-sm-only"><?php echo ($vo['node_id']); ?></td>
                  <td class="am-hide-sm-only">
                    <?php echo $vo['is_service'] == 1 ? '否':'是'; ?>
                  </td>
                  <td class="am-hide-sm-only"><?php echo (date("Y-m-d H:i:s",$vo['create_time'])); ?></td>
                  <td>
                    <div class="am-btn-toolbar">
                      <div class="am-btn-group am-btn-group-xs">
                        <a  href="<?php echo U('userEdit',array('id'=>$vo['id']));?>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>&nbsp;&nbsp;
                        ...
                        <a  href="<?php echo U('Service/editService',array('id'=>$vo['id']));?>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 设置服务中心</a>&nbsp;&nbsp;
