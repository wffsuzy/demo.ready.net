    ...
    <div class="admin-content-body">
      ...
      <div class="am-g">
        <div class="am-u-sm-12 am-u-md-8 am-u-md-push-1">
          <form class="am-form am-form-horizontal" action="<?php echo U('add_edit_service');?>" method="post">
            ...
            <div class="am-form-group">
              <label for="user-QQ" class="am-u-sm-3 am-form-label">服务中心</label>
              <div class="am-u-sm-9">
                <select data-am-selected="{btnSize: 'sm'}" name="is_service">
