          ...
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tr>
                ...
                <th class="table-type">奖金积分</th>
                <th class="table-type">充值积分</th>
                <th class="table-author am-hide-sm-only">商品类别</th>
                <th class="table-author am-hide-sm-only">商品属性</th>
                <th class="table-date am-hide-sm-only">投放区域</th>
              ...
              <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td><?php echo ($vo['gc_name']); ?></td>
                  <td>
                    <?php $area = C('AREA'); $protype = $vo['pro_type'] == 1 ? '注册单':'零售单'; $fenqu = $area[$vo['home']]; $status = $vo['status'] == 1 ? '上架' : '下架'; ?>
                    <?php echo ($protype); ?>
                  </td>
                  <td><?php echo ($fenqu); ?></td>
                  <td><?php echo ($status); ?></td>
                  <td><?php echo (date("Y-m-d H:i:s",$vo['create_time'])); ?></td>
                  <td>
                    <div class="am-btn-toolbar">
                      <div class="am-btn-group am-btn-group-xs">
                        <a href="<?php echo U('edit_menu',array('id'=>$vo['id']));?>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
