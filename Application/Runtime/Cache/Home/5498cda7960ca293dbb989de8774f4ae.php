        ...
        <div class="login-box">
            ...
            <div class="am-tabs" id="doc-my-tabs">
                <ul class="am-tabs-nav am-nav am-nav-tabs am-nav-justify">
                    <li class="am-active"><a href="">账户绑定</a></li>
                    <a href="<?php echo U('register');?>" class="zcnext am-fr am-btn-default">注册</a>
                </ul>

                <div class="am-tabs-bd">
                    <div class="am-tab-panel am-active">
                        <form method="post" action="<?php echo U('bind_phone');?>">
                            ...
                            <div class="am-cf">
                                <input type="submit" name="" value="立即绑定" class="am-btn am-btn-primary am-btn-sm am-fl">
                            </div>
                        </form>
